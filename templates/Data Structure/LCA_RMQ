...
/// NOTE: this class is taken totally from NealWu on github
class LCA {
private:
    int n = 0;
...
public:
    ...
    int get_lca(int a, int b) const {
        ...
        if (a > b) swap(a, b);
        return euler[rmq.ind_query_o1(a, b + 1)];
    }
    ...
    int child_ancestor(int a, int b) const {
        ...
        int child = euler[rmq.ind_query_o1(first_occurrence[a], first_occurrence[b] + 1) + 1];
